...
<div class="modal" id="gallery-modal">
    ...
    <div class="window-container modal-container">
        <div class="window overflow-hidden modal-window d-flex justify-content-between align-items-center flex-column px-4 pb-2 pt-2" id="gallery-window">
            ...
            <!-- Telecharger -->
            <div class="d-flex justify-content-end align-items-center w-100 mt-2 mx-4 gap-4"> 
