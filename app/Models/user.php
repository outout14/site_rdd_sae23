...
class User {
  ...
  public function update($id, $lastname, $firstname, $email, $phone_number, $city, $family_count, $company, $promotion, $promotion_year, $display_in_list, $display_on_map, $confirmed, $status, $role): void {
    ...
    $stmt = $mysqlConnection->prepare($query);
    $stmt->bind_param("ssssssisssiiissi", $lastname, $firstname, $email, $phone_number, $city, $family_count, $company, $promotion, $promotion_year, $display_in_list, $display_on_map, $confirmed, $status, $role, $id);
    $stmt->execute();
    $stmt->close();
  }
